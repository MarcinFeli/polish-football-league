<template>
	<BaseModal :title="t('matches.editMatchResult')" :save-button-text="t('buttons.saveResult')" @close="$emit('close')" @save="saveResult">
		<div>
			<div class="flex items-center justify-between mb-4">
				<div class="text-center">
					<p class="font-semibold dark:text-white">{{ match.homeTeam }}</p>
					<p class="text-sm text-gray-500 dark:text-gray-400">({{ t('matches.home') }})</p>
				</div>
				<div class="text-center">
				...
				<div class="text-center">
					...
					<p class="text-sm text-gray-500 dark:text-gray-400">({{ t('matches.away') }})</p>
				</div>
			</div>

			<div class="flex items-center justify-center space-x-4">
				<div class="flex flex-col items-center">
					<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ t('matches.homeScore') }} </label>
					<input
				...
				<div class="flex flex-col items-center">
					<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ t('matches.awayScore') }}</label>
					<input
